...
def test_fetch_polygon_agg_bars(
    ...
    assert result.to_json(indent=4) == mock_response.to_json(indent=4)
...
#     mock_constructor.return_value.construct_aggregate_bars_endpoint = MagicMock(return_value='mock_endpoint')
#     mock_service.return_value.fetch_data_with_endpoint.return_value = mock_response
