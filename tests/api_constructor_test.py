...
class TestAlphaVantageApiConstructor(unittest.TestCase):
    ...
    def test_construct_time_series_daily_endpoint(self):
        constructor = AlphaVantageApiConstructor(base_url='https://www.alphavantage.co/query')
        endpoint = constructor.construct_time_series_daily_endpoint(symbol='IBM', api_key='fake_api_key')
